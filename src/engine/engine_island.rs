...
pub fn clearIsland(d: *mut mjData, parena: usize) {
...
/// Calls: cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_island.c:_clearIsland, cxx:_mj_arenaAllocByte, cxx:_mj_warning
#[allow(unused_variables, non_snake_case)]
pub fn arenaAllocIsland(m: *const mjModel, d: *mut mjData) -> i32 {
    ...
    unsafe {
        ...
        macro_rules! arena_alloc_field {
            ($field:ident, $ty:ty, $nr:expr) => {
                (*d).$field = crate::engine::engine_memory::mj_arenaAllocByte(
                    d,
...
#[allow(unused_variables, non_snake_case)]
pub fn treeIterInit(m: *const mjModel, d: *const mjData, i: i32, iter: *mut mjTreeIter) {
...
/// Calls: cxx:_mju_copyInt, cxx:_mju_fillInt
#[allow(unused_variables, non_snake_case)]
pub fn mj_floodFill(island: *mut i32, nr: i32, rownnz: *const i32, rowadr: *const i32, colind: *const i32, stack: *mut i32) -> i32 {
    // SAFETY: caller guarantees all pointers are valid with sufficient length
    unsafe {
        let mut nisland: i32 = 0;
        crate::engine::engine_util_misc::mju_fillInt(island, -1, nr);
