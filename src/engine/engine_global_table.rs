...
pub fn reentrant_write_lock_lock_count_on_current_thread() -> *mut i32 {
    ...
    // SAFETY: no pointer params; returns thread-local counter pointer
    let result = unsafe { ReentrantWriteLock_LockCountOnCurrentThread() };
...
pub fn global_table_count(self_ptr: *mut GlobalTable) -> i32 {
    ...
    extern "C" { fn GlobalTable_count(self_ptr: *mut GlobalTable) -> i32; }
    unsafe { GlobalTable_count(self_ptr) }
}
...
pub fn global_table_lock_exclusively(self_ptr: *mut GlobalTable) -> ReentrantWriteLock {
    ...
    extern "C" { fn GlobalTable_LockExclusively(self_ptr: *mut GlobalTable) -> ReentrantWriteLock; }
    unsafe { GlobalTable_LockExclusively(self_ptr) }
}
...
pub fn global_table_append_if_unique(self_ptr: *mut GlobalTable, obj: *const T) -> i32 {
    if self_ptr.is_null() || obj.is_null() {
        return -1;
    }
    extern "C" { fn GlobalTable_AppendIfUnique(self_ptr: *mut GlobalTable, obj: *const T) -> i32; }
    unsafe { GlobalTable_AppendIfUnique(self_ptr, obj) }
}
...
pub fn global_table_get_at_slot_unsafe(self_ptr: *mut GlobalTable, slot: i32, nslot: i32) -> *const T {
    if self_ptr.is_null() || slot < 0 || slot >= nslot {
        return core::ptr::null();
    }
    extern "C" { fn GlobalTable_GetAtSlotUnsafe(self_ptr: *mut GlobalTable, slot: i32, nslot: i32) -> *const T; }
    unsafe { GlobalTable_GetAtSlotUnsafe(self_ptr, slot, nslot) }
}
...
pub fn global_table_get_by_key_unsafe(self_ptr: *mut GlobalTable, key: string_view, slot: *mut i32, nslot: i32) -> *const T {
    ...
    extern "C" { fn GlobalTable_GetByKeyUnsafe(self_ptr: *mut GlobalTable, key: string_view, slot: *mut i32, nslot: i32) -> *const T; }
    unsafe { GlobalTable_GetByKeyUnsafe(self_ptr, key, slot, nslot) }
}
...
pub fn global_table_get_at_slot(self_ptr: *mut GlobalTable, slot: i32) -> *const T {
    if self_ptr.is_null() || slot < 0 {
        return core::ptr::null();
    }
    extern "C" { fn GlobalTable_GetAtSlot(self_ptr: *mut GlobalTable, slot: i32) -> *const T; }
    unsafe { GlobalTable_GetAtSlot(self_ptr, slot) }
}
...
pub fn global_table_get_by_key(self_ptr: *mut GlobalTable, key: string_view, slot: *mut i32) -> *const T {
    ...
    extern "C" { fn GlobalTable_GetByKey(self_ptr: *mut GlobalTable, key: string_view, slot: *mut i32) -> *const T; }
    unsafe { GlobalTable_GetByKey(self_ptr, key, slot) }
}
...
pub fn global_table_mutex(self_ptr: *mut GlobalTable) -> *mut Mutex {
    ...
    extern "C" { fn GlobalTable_mutex(self_ptr: *mut GlobalTable) -> *mut Mutex; }
    unsafe { GlobalTable_mutex(self_ptr) }
}
