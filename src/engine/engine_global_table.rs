...
/// Calls: GlobalTable::CopyObject, GlobalTable::HumanReadableTypeName, GlobalTable::LockExclusively, GlobalTable::ObjectEqual, GlobalTable::ObjectKey, mju_error
#[allow(unused_variables, non_snake_case)]
