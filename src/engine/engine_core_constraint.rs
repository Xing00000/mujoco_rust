...
/// Calls: cxx:_mju_dist3, cxx:_mju_max, cxx:_mju_message, cxx:_mju_scl, cxx:_mju_sum
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_elemBodyWeight(m: *const mjModel, d: *const mjData, f: i32, e: i32, v: i32, point: *const f64, body: *mut i32, weight: *mut f64) -> i32 {
...
/// Calls: cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_util_sparse.h:_mju_compare, cxx:_mj_isSparse, cxx:_mju_copy, cxx:_mju_copyInt, cxx:_mju_fillInt, cxx:_mju_message
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_addConstraint(m: *const mjModel, d: *mut mjData, jac: *const f64, pos: *const f64, margin: *const f64, frictionloss: f64, size: i32, r#type: i32, id: i32, NV: i32, chain: *const i32) {
    ...
    unsafe {
        ...
        // sparse: copy chain
            ...
            crate::engine::engine_util_misc::mju_fillInt(
...
/// Calls: cxx:_mju_addTo3, cxx:_mju_copy3, cxx:_mju_mulMatVec3
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_equalityAnchors(m: *const mjModel, d: *const mjData, eq_id: i32, pos1: *mut f64, pos2: *mut f64, body1: *mut i32, body2: *mut i32) {
...
#[allow(unused_variables, non_snake_case)]
pub fn mj_addConstraintCount(m: *const mjModel, size: i32, NV: i32) -> i32 {
...
/// Calls: cxx:_mj_defaultSolRefImp, cxx:_mju_copy, cxx:_mju_max, cxx:_mju_min, cxx:_mju_warning, cxx:_mju_zero
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
...
pub fn getsolparam(m: *const mjModel, d: *const mjData, i: i32, solref: *mut f64, solreffriction: *mut f64, solimp: *mut f64) {
    ...
    unsafe {
        ...
        if (*solref.add(0) > 0.0) ^ (*solref.add(1) > 0.0) {
            ...
            crate::engine::engine_init::mj_defaultSolRefImp(solref, std::ptr::null_mut());
        }
...
/// Calls: cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_core_constraint.c:_power
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
...
#[allow(unused_variables, non_snake_case)]
pub fn computeY_precount(Y_rownnz: *mut i32, Y_rowadr: *mut i32, nefc: i32, nv: i32, J_rownnz: *const i32, J_rowadr: *const i32, J_colind: *const i32, M_rownnz: *const i32, M_rowadr: *const i32, M_colind: *const i32, marker: *mut i32) -> i32 {
    // SAFETY: All pointer args are valid arrays with proper bounds (caller contract).
    unsafe {
        crate::engine::engine_util_misc::mju_fillInt(marker, -1, nv);
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn computeY_fill(Y: *mut f64, Y_colind: *mut i32, Y_rownnz: *const i32, Y_rowadr: *const i32, nefc: i32, J: *const f64, J_rownnz: *const i32, J_rowadr: *const i32, J_colind: *const i32, dof_parentid: *const i32) {
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn computeY_backsub(Y: *mut f64, Y_rownnz: *const i32, Y_rowadr: *const i32, Y_colind: *const i32, nefc: i32, qLD: *const f64, M_rownnz: *const i32, M_rowadr: *const i32, M_colind: *const i32, sqrtInvD: *const f64) {
...
#[allow(unused_variables, non_snake_case)]
pub fn mj_isDual(m: *const mjModel) -> i32 {
...
/// Calls: cxx:_mj_isSparse, cxx:_mju_mulMatVec, cxx:_mju_mulMatVecSparse
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_mulJacVec(m: *const mjModel, d: *const mjData, res: *mut f64, vec: *const f64) {
...
/// Calls: cxx:_mj_isSparse, cxx:_mju_mulMatTVec, cxx:_mju_mulMatTVecSparse
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_mulJacTVec(m: *const mjModel, d: *const mjData, res: *mut f64, vec: *const f64) {
    ...
    unsafe {
        ...
        if crate::engine::engine_core_util::mj_isSparse(m) != 0 {
            crate::engine::engine_util_sparse::mju_mulMatTVecSparse(
                res, (*d).efc_J, vec, (*d).nefc, (*m).nv as i32,
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_assignRef(m: *const mjModel, target: *mut f64, source: *const f64) {
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_assignImp(m: *const mjModel, target: *mut f64, source: *const f64) {
    const mjENBL_OVERRIDE: i32 = 1 << 0;
    const mjNIMP: i32 = 5;
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_assignFriction(m: *const mjModel, target: *mut f64, source: *const f64) {
    const mjENBL_OVERRIDE: i32 = 1 << 0;
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_assignMargin(m: *const mjModel, source: f64) -> f64 {
...
/// Calls: cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_core_constraint.c:_getimpedance, cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_core_constraint.c:_getposdim, cxx-internal:/Users/xing/Desktop/projects/c2rust_bitexact/projects/mujoco/src/engine/engine_core_constraint.c:_getsolparam, cxx:_mju_max
#[allow(unused_variables, non_snake_case)]
pub fn mj_makeImpedance(m: *const mjModel, d: *mut mjData) {
    const MJ_MINVAL: f64 = 1E-15;
...
/// Calls: cxx:_mju_norm, cxx:_mju_zero
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_constraintUpdate_impl(ne: i32, nf: i32, nefc: i32, D: *const f64, R: *const f64, floss: *const f64, jar: *const f64, r#type: *const i32, id: *const i32, contact: *mut mjContact, state: *mut i32, force: *mut f64, cost: *mut f64, flg_coneHessian: i32) {
...
/// Calls: cxx:_mj_constraintUpdate_impl, cxx:_mj_mulJacTVec
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mj_constraintUpdate(m: *const mjModel, d: *mut mjData, jar: *const f64, cost: *mut f64, flg_coneHessian: i32) {
    ...
    unsafe {
        ...
        mj_mulJacTVec(m, d as *const mjData, (*d).qfrc_constraint, (*d).efc_force);
    }
}
