...
pub fn get_attr_ptr(val: *mut T) -> i32 {
    ...
    // Previous return: i32
    extern "C" { fn GetAttrPtr_impl (val : * mut T) -> i32 ; } unsafe { GetAttrPtr_impl (val) }
}
...
pub fn mj_x_reader_parse(self_ptr: *mut mjXReader, root: *mut tinyxml2__XMLElement, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_Parse_impl(self_ptr: *mut mjXReader, root: *mut tinyxml2__XMLElement, vfs: *const mjVFS); }
    // SAFETY: delegates to C++ implementation; caller guarantees pointer validity
    unsafe { mjXReader_Parse_impl(self_ptr, root, vfs) }
}
...
pub fn mj_x_reader_model_file_dir(self_ptr: *mut mjXReader) -> *const mujoco__user__FilePath {
    ...
    extern "C" { fn mjXReader_ModelFileDir_impl (self_ptr : * mut mjXReader) -> * const mujoco__user__FilePath ; } unsafe { mjXReader_ModelFileDir_impl (self_ptr) }
}
...
pub fn mj_x_reader_default(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, def: *const mjsDefault, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_Default_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, def: *const mjsDefault, vfs: *const mjVFS); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Default_impl(self_ptr, section, def, vfs) }
}
...
pub fn mj_x_reader_extension(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement) {
    extern "C" { fn mjXReader_Extension_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Extension_impl(self_ptr, section) }
}
...
pub fn mj_x_reader_asset(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_Asset_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, vfs: *const mjVFS); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Asset_impl(self_ptr, section, vfs) }
}
...
pub fn mj_x_reader_body(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, pbody: *mut mjsBody, pframe: *mut mjsFrame, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_Body_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, pbody: *mut mjsBody, pframe: *mut mjsFrame, vfs: *const mjVFS); }
    // SAFETY: delegates to C++ implementation; caller guarantees pointer validity
    unsafe { mjXReader_Body_impl(self_ptr, section, pbody, pframe, vfs) }
}
...
pub fn mj_x_reader_contact(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement) {
    extern "C" { fn mjXReader_Contact_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Contact_impl(self_ptr, section) }
}
...
pub fn mj_x_reader_deformable(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_Deformable_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement, vfs: *const mjVFS); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Deformable_impl(self_ptr, section, vfs) }
}
...
pub fn mj_x_reader_equality(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement) {
    extern "C" { fn mjXReader_Equality_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Equality_impl(self_ptr, section) }
}
...
pub fn mj_x_reader_actuator(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement) {
    extern "C" { fn mjXReader_Actuator_impl(self_ptr: *mut mjXReader, section: *mut tinyxml2__XMLElement); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_Actuator_impl(self_ptr, section) }
}
...
pub fn mj_x_reader_one_camera(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, pcamera: *mut mjsCamera) {
    extern "C" { fn mjXReader_OneCamera_impl(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, pcamera: *mut mjsCamera); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_OneCamera_impl(self_ptr, elem, pcamera) }
}
...
pub fn mj_x_reader_one_flexcomp(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, pbody: *mut mjsBody, vfs: *const mjVFS) {
    extern "C" { fn mjXReader_OneFlexcomp_impl(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, pbody: *mut mjsBody, vfs: *const mjVFS); }
    // SAFETY: delegates to C++ implementation; caller guarantees pointer validity
    unsafe { mjXReader_OneFlexcomp_impl(self_ptr, elem, pbody, vfs) }
}
...
pub fn mj_x_reader_one_plugin(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, plugin: *mut mjsPlugin) {
    extern "C" { fn mjXReader_OnePlugin_impl(self_ptr: *mut mjXReader, elem: *mut tinyxml2__XMLElement, plugin: *mut mjsPlugin); }
    // SAFETY: delegates to C implementation
    unsafe { mjXReader_OnePlugin_impl(self_ptr, elem, plugin) }
}
...
pub fn mj_x_reader_asset_dir(self_ptr: *mut mjXReader) -> mujoco__user__FilePath {
    extern "C" { fn mjXReader_AssetDir_impl(self_ptr: *mut mjXReader) -> mujoco__user__FilePath; }
    // SAFETY: delegates to C++ implementation; caller guarantees self_ptr is valid
    unsafe { mjXReader_AssetDir_impl(self_ptr) }
}
