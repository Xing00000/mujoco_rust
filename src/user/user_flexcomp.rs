...
pub fn mj_c_flexcomp_make(self_ptr: *mut mjCFlexcomp, body: *mut mjsBody, error: *mut i8, error_sz: i32, vfs: *const mjVFS) -> bool {
    extern "C" { fn mjCFlexcomp_Make_impl(self_ptr: *mut mjCFlexcomp, body: *mut mjsBody, error: *mut i8, error_sz: i32, vfs: *const mjVFS) -> bool; }
    // SAFETY: delegates to C implementation
    unsafe { mjCFlexcomp_Make_impl(self_ptr, body, error, error_sz, vfs) }
}
