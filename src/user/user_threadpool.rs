...
pub fn thread_pool_num_threads(self_ptr: *mut ThreadPool) -> i32 {
    extern "C" { fn ThreadPool_NumThreads_impl(self_ptr: *mut ThreadPool) -> i32; }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_NumThreads_impl(self_ptr) }
}

/// C: ThreadPool::WorkerId (user/user_threadpool.h:42)
#[allow(unused_variables, non_snake_case)]
pub fn thread_pool_worker_id() -> i32 {
    extern "C" { fn ThreadPool_WorkerId_impl() -> i32; }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_WorkerId_impl() }
}
...
pub fn thread_pool_get_count(self_ptr: *mut ThreadPool) -> std__uint64_t {
    extern "C" { fn ThreadPool_GetCount_impl(self_ptr: *mut ThreadPool) -> std__uint64_t; }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_GetCount_impl(self_ptr) }
}

/// C: ThreadPool::ResetCount (user/user_threadpool.h:55)
#[allow(unused_variables, non_snake_case)]
pub fn thread_pool_reset_count(self_ptr: *mut ThreadPool) {
    extern "C" { fn ThreadPool_ResetCount_impl(self_ptr: *mut ThreadPool); }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_ResetCount_impl(self_ptr) }
}

/// C: ThreadPool::WaitCount (user/user_threadpool.h:61)
#[allow(unused_variables, non_snake_case)]
pub fn thread_pool_wait_count(self_ptr: *mut ThreadPool, value: i32) {
    extern "C" { fn ThreadPool_WaitCount_impl(self_ptr: *mut ThreadPool, value: i32); }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_WaitCount_impl(self_ptr, value) }
}

/// C: ThreadPool::WorkerThread (user/user_threadpool.h:70)
#[allow(unused_variables, non_snake_case)]
pub fn thread_pool_worker_thread(self_ptr: *mut ThreadPool, i: i32) {
    extern "C" { fn ThreadPool_WorkerThread_impl(self_ptr: *mut ThreadPool, i: i32); }
    // SAFETY: delegates to C implementation
    unsafe { ThreadPool_WorkerThread_impl(self_ptr, i) }
}
