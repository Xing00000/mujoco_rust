...
/// Calls: mjCComposite::CopyIntoSkin, mjCComposite::MakeCableBones, mjs_setName
/// ⚠️ BITEXACT RULES:
...
/// Calls: mjCComposite::CopyIntoSkin, mjCComposite::MakeCableBonesSubgrid, mjs_setName, mju_free, mju_mulMatMat, mju_round, mju_zero
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
...
/// Calls: mjs_addBody, mjs_getDefault, mjs_setDefault, mjs_setFrame, mjs_setName, mjuu_mulquat, mjuu_normvec, mjuu_setvec, mjuu_updateFrame, mjuu_zerovec
/// ⚠️ BITEXACT RULES:
///   1. Copy exact C accumulation order (no iter().sum())
///   2. No f64::mul_add() (FMA changes precision)
///   3. No algebraic simplification
