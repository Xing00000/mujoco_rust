...
pub fn mjs_default_orientation(orient: *mut mjsOrientation) {
    // WARNING: signature changed — verify body
    // Previous params: (orient : * mut mjsOrientation)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_frame(frame: *mut mjsFrame) {
    // WARNING: signature changed — verify body
    // Previous params: (frame : * mut mjsFrame)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_joint(joint: *mut mjsJoint) {
    // WARNING: signature changed — verify body
    // Previous params: (joint : * mut mjsJoint)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_geom(geom: *mut mjsGeom) {
    // WARNING: signature changed — verify body
    // Previous params: (geom : * mut mjsGeom)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_site(site: *mut mjsSite) {
    // WARNING: signature changed — verify body
    // Previous params: (site : * mut mjsSite)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_camera(camera: *mut mjsCamera) {
    // WARNING: signature changed — verify body
    // Previous params: (camera : * mut mjsCamera)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_light(light: *mut mjsLight) {
    // WARNING: signature changed — verify body
    // Previous params: (light : * mut mjsLight)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_flex(flex: *mut mjsFlex) {
    // WARNING: signature changed — verify body
    // Previous params: (flex : * mut mjsFlex)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_mesh(mesh: *mut mjsMesh) {
    // WARNING: signature changed — verify body
    // Previous params: (mesh : * mut mjsMesh)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_h_field(hfield: *mut mjsHField) {
    // WARNING: signature changed — verify body
    // Previous params: (hfield : * mut mjsHField)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_texture(texture: *mut mjsTexture) {
    // WARNING: signature changed — verify body
    // Previous params: (texture : * mut mjsTexture)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_material(material: *mut mjsMaterial) {
    // WARNING: signature changed — verify body
    // Previous params: (material : * mut mjsMaterial)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_pair(pair: *mut mjsPair) {
    // WARNING: signature changed — verify body
    // Previous params: (pair : * mut mjsPair)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_equality(equality: *mut mjsEquality) {
    // WARNING: signature changed — verify body
    // Previous params: (equality : * mut mjsEquality)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_tendon(tendon: *mut mjsTendon) {
    // WARNING: signature changed — verify body
    // Previous params: (tendon : * mut mjsTendon)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_sensor(sensor: *mut mjsSensor) {
    // WARNING: signature changed — verify body
    // Previous params: (sensor : * mut mjsSensor)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_numeric(numeric: *mut mjsNumeric) {
    // WARNING: signature changed — verify body
    // Previous params: (numeric : * mut mjsNumeric)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_text(text: *mut mjsText) {
    // WARNING: signature changed — verify body
    // Previous params: (text : * mut mjsText)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_tuple(tuple: *mut mjsTuple) {
    // WARNING: signature changed — verify body
    // Previous params: (tuple : * mut mjsTuple)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_key(key: *mut mjsKey) {
    // WARNING: signature changed — verify body
    // Previous params: (key : * mut mjsKey)
    // Previous return: ()
    todo ! ()
}
...
pub fn mjs_default_plugin(plugin: *mut mjsPlugin) {
    // WARNING: signature changed — verify body
    // Previous params: (plugin : * mut mjsPlugin)
    // Previous return: ()
    todo ! ()
}
