...
/// Calls: cxx:_mjr_crossVec, cxx:_mjr_normalizeVec
/// ⚠️ BITEXACT RULES:
...
pub fn mjr_makeNormal(normal: *mut f32, p1: *const f32, p2: *const f32, p3: *const f32) {
    ...
    unsafe {
        ...
        mjr_crossVec(normal, v1.as_ptr(), v2.as_ptr());
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mjr_mulMat44(res: *mut f32, A: *const f32, B: *const f32) {
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mjr_crossVec(a: *mut f32, b: *const f32, c: *const f32) {
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mjr_normalizeVec(v: *mut f32) {
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mjr_orthoVec(res: *mut f32, v: *const f32) {
    ...
    unsafe {
        ...
        mjr_crossVec(res, v, other.as_ptr());
...
///   4. No iter().sum()/product() (order undefined)
#[allow(unused_variables, non_snake_case)]
pub fn mjr_dotVec(a: *const f32, b: *const f32) -> f32 {
...
#[allow(unused_variables, non_snake_case)]
pub fn mjr_findRect(x: i32, y: i32, nrect: i32, rect: *const mjrRect) -> i32 {
    let mut i: i32 = 0;
    while i < nrect {
