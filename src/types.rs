...
pub struct mjData {
    ...
    pub maxuse_con: i32,
    pub maxuse_efc: i32,
    pub solver: [mjSolverStat; 4000],
    pub solver_niter: [i32; 20],
    pub solver_nnz: [i32; 20],
    pub solver_fwdinv: [f64; 2],
    pub warning: [mjWarningStat; 7],
    pub timer: [mjTimerStat; 15],
    pub ncon: i32,
    pub ne: i32,
    pub nf: i32,
    pub nl: i32,
...
#[derive(Clone, Copy)]
pub struct mjVisual {
    pub global: struct__unnamed_at__Users_xing_Desktop_projects_c2rust_bitexact_projects_mujoco_include_mujoco_mjmodel_h_132_3,
    pub quality: struct__unnamed_at__Users_xing_Desktop_projects_c2rust_bitexact_projects_mujoco_include_mujoco_mjmodel_h_148_3,
    ...
    pub map: struct__unnamed_at__Users_xing_Desktop_projects_c2rust_bitexact_projects_mujoco_include_mujoco_mjmodel_h_163_3,
    pub scale: struct__unnamed_at__Users_xing_Desktop_projects_c2rust_bitexact_projects_mujoco_include_mujoco_mjmodel_h_179_3,
